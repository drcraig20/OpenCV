...
# sort the contours from top to bottom then initialize the total number of correct answers
...
for (question, i) in enumerate(np.arange(0, len(questionCnts), 5)):
    ...
    for(j, c) in enumerate(cnts):
        # creates a mask that reveals only the current bubble for the question
